...
export default function Alertes() {
  ...
  return (
    <div className="px-4 py-5 space-y-4">
      <div>
        <h2 className="text-lg font-black text-gray-900">🔔 Alertes</h2>
        <p className="text-xs text-gray-400">Notifications en temps réel</p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {alerts?.map((a, i) => (
            <div key={i} className={`rounded-2xl p-4 border ${typeColors[a.type] || typeColors.info}`}>
